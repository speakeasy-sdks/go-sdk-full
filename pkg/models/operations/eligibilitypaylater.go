...
func (e EligibilityPaylaterRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(e, "", false)
}

func (e *EligibilityPaylaterRequest) UnmarshalJSON(data []byte) error {
...
func (o *EligibilityPaylaterResponse) GetClasses() []shared.EligiblePaylater {
	if o == nil {
		return nil
	}
	return o.Classes
